...
### 内容适配规则
同一条核心内容发到不同平台时，**必须**按以下规则适配后再发布：

| 平台 | 字数上限 | Hashtag | 调性 | 媒体要求 |
|------|---------|---------|------|---------|
| Instagram | 2200字 | 必加，5-15个，末尾追加 | 视觉美感、生活方式 | 必须有图片/视频 |
| Facebook | 无硬限（建议<500字） | 可选，0-3个 | 社区、对话感，可以更长更详细 | 可选 |
| TikTok | 2200字 | 必加，3-5个，影响分发 | 娱乐、快节奏 | 必须有视频 |
| YouTube | 5000字(描述) | 必加，5-10个 | 专业、信息量 | 必须有视频 |
| LinkedIn | 3000字 | 可选，3-5个 | 专业、商业洞察 | 可选 |
| X | 280字 | 可选，1-3个 | 简短、有观点 | 可选 |
| 小红书 | 1000字 | 必加，话题标签 | 种草、真实感 | 必须有图片 |
| GBP | 1500字 | 不支持 | 商业信息、促销 | 可选 |

**适配步骤：**
1. 从 queue 拿到原始 content（HTML），去除标签得到纯文本
2. 根据 providerIdentifier 查上表
3. 超字数 → 精简（保留核心信息，删减细节）
4. 加/调 hashtag（根据平台规则）
5. 调整调性（同一内容，IG 偏美感，FB 偏社区，X 偏精炼）
6. 检查媒体要求（无图的帖子不能发 IG/小红书，无视频不能发 TikTok）
